...
const getTypeLabel = (type: TransactionFilterType): string => {
    switch(type) {
        case TransactionFilterType.INCOME: return 'Income';
        case TransactionFilterType.EXPENSE: return 'Expense';
        case TransactionFilterType.TRANSFER: return 'Transfers';
        case TransactionFilterType.ADJUSTMENT: return 'Adjustments';
        default: return '';
    }
}
