    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <button 
            onClick={() => handleSelect(ActionType.BULK_TRANSACTION)} 
            className={`${fabOptionClasses(isOpen, 'delay-75')} hover:scale-105 hover:bg-indigo-100 dark:hover:bg-indigo-600`}
            tabIndex={isOpen ? 0 : -1}
          >
            Bulk Transactions / மொத்த பரிவர்த்தனைகள்
